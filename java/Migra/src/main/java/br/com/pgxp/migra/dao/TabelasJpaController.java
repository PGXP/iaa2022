...
public class TabelasJpaController implements Serializable {
    ...
    public List<Tabelas> findTabelas(Integer ano, Integer mes, Integer dia, Integer idfilial, Integer idlocal, Integer idproduto) {
        EntityManager em = getEntityManager();
        try {
            return em.createQuery("SELECT c FROM Tabelas c where c.dia = :dia and c.mes = :mes and c.ano = :ano and c.idfilial = :idfilial and c.idlocal = :idlocal and c.idproduto = :idproduto", Tabelas.class)
                    .setParameter("dia", dia)
                    .setParameter("mes", mes)
                    .setParameter("ano", ano)
    ...
    public List<Tabelas> findTabelasUltimoValor(Integer ano, Integer mes, Integer dia, Integer idfilial, Integer idlocal, Integer idproduto) {
        EntityManager em = getEntityManager();
        try {
            return em.createQuery("SELECT c FROM Tabelas c where c.dia <= :dia and c.mes <= :mes and c.ano = :ano and  c.idfilial = :idfilial and c.idlocal = :idlocal and c.idproduto = :idproduto order by c.ano, c.mes, c.dia", Tabelas.class)
                    .setParameter("dia", dia)
                    .setParameter("mes", mes)
                    .setParameter("ano", ano)
                    .setParameter("idfilial", idfilial)
    ...
    public List<Tabelas> findTabelasProximoValor(Integer ano, Integer mes, Integer dia, Integer idfilial, Integer idlocal, Integer idproduto) {
        EntityManager em = getEntityManager();
        try {
            return em.createQuery("SELECT c FROM Tabelas c where c.dia >= :dia and c.mes >= :mes and c.ano = :ano and c.idfilial = :idfilial and c.idlocal = :idlocal and c.idproduto = :idproduto order by c.ano, c.mes, c.dia", Tabelas.class)
                    .setParameter("dia", dia)
