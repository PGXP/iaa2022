 ...
 * @author Serpro
 */
public class Grupo15RunnerCreate implements Runnable {

    private static final Logger LOG = getLogger(Grupo15RunnerCreate.class.getName());
    ...
    public void run() {
        ...
        try {
            ...
            LOG.log(INFO, "Grupo15 Create {0} ", new Object[]{table.toString()});

        } catch (Exception ex) {
            Logger.getLogger(Grupo15RunnerCreate.class.getName()).log(Level.SEVERE, null, ex);
        }
