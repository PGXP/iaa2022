...
path = 'letras/*/*'
df = pd.read_json("/home/desktop/Documentos/biblia.json")
texto = df['texto']
...
for filename in glob.glob(path):
    ...
    with open(filename, errors='ignore') as letras_file:
        for line in letras_file:
            data.append(Message(line, False)
           

for linha in texto:
    data.append(Message(linha, True))
