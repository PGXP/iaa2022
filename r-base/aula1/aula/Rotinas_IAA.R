...
salarios <- read.csv("/home/desktop/Downloads/estatistica/aula1/cps91.txt", sep="")
...
save ("salarios", file = "/home/desktop/Downloads/estatistica/aula1/salarios.RData")


# Carregar conjunto de dados salvo no formato do R

load("/home/desktop/Downloads/estatistica/aula1/salarios.RData")
...
with(salarios, Hist(age, scale="frequency", breaks="sturges", col="darkgray"))
?Hist
...
## Importar os Dados
ceo <- read.table("/home/desktop/Downloads/estatistica/aula1/ceo.txt", header = TRUE, sep = "", 
                  na.strings = "NA", dec = ".", strip.white = TRUE)

save ("ceo", file = "/home/desktop/Downloads/estatistica/aula1/ceo.RData")
load("/home/desktop/Downloads/estatistica/aula1/ceo.RData")
...
basepetr4 <- read_excel("/home/desktop/Downloads/estatistica/aula1/basepetr4.xlsx")
